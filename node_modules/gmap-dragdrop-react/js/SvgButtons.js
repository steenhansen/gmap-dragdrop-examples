...
var SvgButton = /*#__PURE__*/function () {
  function SvgButton() {
  ...
  _createClass(SvgButton, null, [{
    ...
    value: function standardMapImage(image_name) {
      ...
      var image_element = "<a href=\"images/".concat(image_name, "\" target=\"_blank\"><img  width=\"").concat(img_width, "px\" src=\"images/").concat(image_name, "\"/></a>");
    ...
    value: function clear_all(clear_all_options) {
      var clear_all_defaults = this.initSvg(clear_all_options);
    ...
    value: function initSvg(clear_all_options) {
      ...
      var unique_class = this.unique_class_count;
      var clear_all_defaults = this.insertDefault(clear_all_options);
      ...
      var main_svg = "clear-main-".concat(unique_class);
      var minor_svg = "clear-minor-".concat(unique_class);
      var svg_css = "\n        <style>\n            .".concat(main_svg, " {\n                fill :").concat(minor_color, ";\n                fill-opacity:").concat(normal_opacity, ";\n                opacity:").concat(normal_opacity, ";\n            }\n            .").concat(main_svg, ":hover {\n                fill:").concat(minor_hover, ";\n                fill-opacity:").concat(hover_opacity, ";\n                opacity:").concat(hover_opacity, ";\n                cursor:pointer;\n            }\n            .").concat(minor_svg, "{\n                fill: inherit\n            }\n        </style> ");
    ...
    value: function do_delete(clear_all_options) {
      ...
      var append_to_id = clear_all_defaults.append_to_id,
          ...
          minor_svg = clear_all_defaults.minor_svg;
      var target_elem = document.getElementById(append_to_id);
      var the_template = " ".concat(svg_css, " \n        <svg width=\"32\" height=\"32\" viewBox='0 0 512 512' >\n            <g display=\"inline\" class=\"").concat(main_svg, "\" style=\"cursor: inherit\">\n                <title>").concat(marker_icon_title, "</title>\n                <rect stroke=\"null\" height=\"512\" width=\"512\" y=\"0\" x=\"0\" stroke-width=\"5\" fill=\"").concat(background_color, "\"></rect>\n                <g class=\"").concat(minor_svg, "\" stroke=\"null\" display=\"inline\">\n                    <rect stroke=\"null\" transform=\"rotate(-90 393.08407592773443,392.5536193847656) \" height=\"183.41317\" width=\"44.95837\" y=\"300.84702\" x=\"370.60487\" stroke-width=\"5\" ></rect>\n                </g>\n                <g display=\"inline\">\n                    <rect stroke=\"null\" fill=\"#ffffff\" stroke-width=\"5\" x=\"185.00379\" y=\"374.64714\" width=\"213.52858\" height=\"27.5\" transform=\"rotate(-78.98575592041016 291.76806640624994,388.39712524414057)\"></rect>\n                </g>\n                <g display=\"inline\" stroke=\"null\">\n                    <path fill=\"").concat(main_color, "\"  d=\"m255.5,1.99999c-69.87445,0 -126.5,56.64136 -126.5,126.5c0,50.89648 30.20484,94.44312 73.50342,114.51709l52.99658,264.98291l52.99658,-264.98291c43.29957,-20.07397 73.50342,-63.62061 73.50342,-114.51709c0,-69.85864 -56.64037,-126.5 -126.5,-126.5zm0,0\" stroke=\"null\"></path>\n                </g>\n            </g>\n        </svg> ");
      target_elem.insertAdjacentHTML(relative_position, the_template);
    }
  }, {
    key: "do_edit",
...
_defineProperty(SvgButton, "unique_class_count", 0);
