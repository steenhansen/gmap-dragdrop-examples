...
function mallsMap(div_id, mall_locations) {
  var mall_options = {
    ...
    onDoubleClick: function onDoubleClick(e) {
      ...
      var latLng = e.latLng;
      var random_color = gmap_event.newRandomColor();
      latLng.pin_color = random_color;
      gmap_event.locationAdd(latLng);
    }
  };

  var gmap_malls = _reactDom["default"].render( /*#__PURE__*/React.createElement(_gmapDragdropReact.GmapDragDrop, {
